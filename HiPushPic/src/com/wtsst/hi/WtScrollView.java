 ...
 * @author guolin
 */
public class WtScrollView extends ScrollView implements OnTouchListener {
	...
	private static Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			WtScrollView myScrollView = (WtScrollView) msg.obj;
	 ...
	 * @param attrs
	 */
	public WtScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
